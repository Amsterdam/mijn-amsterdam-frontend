        ...
        72: (e) => {
          ...
          function o(e, o) {
            for (var i = {}, r = [], a = 0; a < e.length; a++) {
              ...
              if (-1 !== h) (n[h].references++, n[h].updater(p));
                ...
                var b = s(p, o);
                ((o.byIndex = a),
                  n.splice(a, 0, { identifier: u, updater: b, references: 1 }));
              }
              r.push(u);
            }
            return r;
          ...
          e.exports = function (e, s) {
            ...
            return function (e) {
              ...
              for (var d = o(e, s), c = 0; c < i.length; c++) {
                var l = t(i[c]);
      ...
      y = new (class {
        constructor(e, n = 'nl') {
          ((this.licenseKey = e),
            (this.language = n),
            (this.translations = w),
            (localStorage.getItem('_cobrowse_widget_session') ?? !1) &&
              this.init(),
        ...
        async loadCobrowseSDK() {
          ...
          try {
            ...
            return (
              (e.src = 'https://js.cobrowse.io/CobrowseIO.js'),
              (e.async = !0),
              (e.crossOrigin = 'anonymous'),
              new Promise((n, t) => {
                ((e.onload = () => n(window.CobrowseIO)),
                  (e.onerror = () =>
                    t(new Error('Failed to load Cobrowse SDK'))),
                  document.head.appendChild(e));
              })
            );
          } catch (e) {
            console.error('Error loading Cobrowse SDK:', e);
          }
        }
        async init() {
          const e = await this.loadCobrowseSDK();
          ((e.license = this.licenseKey),
            (e.redactedViews = ['.cobrowse-redacted']),
            (this.CobrowseIO = e),
            (this.originalTitle = document.title),
            this.CobrowseIO.currentSession ||
              localStorage.removeItem('_cobrowse_widget_session'),
            e.client().then(async () => {
              (this.CobrowseIO.start(), this.setupSessionControls());
            }),
            (e.confirmSession = async () =>
              this.showConsentDialog(
                this.translations[this.language].request_share,
                this.translations[this.language].consent_message
              )),
            e.on('session.updated', (e) => {
              e.isActive?.() &&
                localStorage.setItem(
                  '_cobrowse_widget_session',
                  JSON.stringify({ id: e.id?.(), state: e.state?.() })
                );
            }),
            e.on('session.ended', () => {
              (localStorage.removeItem('_cobrowse_widget_session'),
                ...
                this.displaySessionCodeModal('', !0));
            }));
        }
        initializeWidget() {
          (document
            ...
            document.addEventListener('keydown', (e) => {
              e.shiftKey && 'Digit6' === e.code && this.startSession();
            }));
        }
        setupSessionControls() {
          (this.createSharingBanner(),
            (this.CobrowseIO.showSessionControls =
              this.showSessionControls.bind(this)),
            (this.CobrowseIO.hideSessionControls =
              this.hideSessionControls.bind(this)));
        }
        createStopButton() {
          ...
          return (
            ...
            (e.textContent = this.translations[this.language].stop_sharing),
            e.addEventListener('click', () => {
              this.CobrowseIO.currentSession && this.endSession();
            }),
            e
          );
        }
        ...
        createCobrowseFrame() {
          ...
          const e = document.createElement('div');
          ((e.id = 'cobrowse-frame'), document.body.appendChild(e));
        }
        removeCobrowseFrame() {
          const e = document.getElementById('cobrowse-frame');
          e && e.remove();
        }
        hideSessionControls() {
        ...
        createSharingBanner() {
          ((this.sharingBanner = document.createElement('div')),
            (this.sharingBanner.className = 'sharing-banner'));
          const e = this.createStopButton();
          (this.sharingBanner.appendChild(e),
        ...
        async startSession() {
          this.sessionCodeContainer ||
            (this.init(), this.displaySessionCodeModal(''));
        }
        displaySessionCodeModal(e, n = null) {
            ...
            this.sessionCodeContainer
              ...
              .addEventListener('click', async () => {
                if (document.getElementById('cobrowse-frame'))
                  ...
                  let e = await this.createSessionCode();
                  ((e = e.slice(0, 3) + '-' + e.slice(3)),
                    (document.getElementById('sessionCode').innerHTML = e),
        ...
        sessionCodeContent(e, n, t, o = null) {
          const s = !0 === o ? 'blue-button' : 'secondary-button',
          ...
          return this.createModal(e, n, i);
        }
        showConsentDialog(e, n) {
          (this.hideModal(this.sessionCodeContainer),
            (this.sessionCodeContainer = null));
          const t = document.createElement('div');
          return (
            t.classList.add('cobrowse-wrapper'),
            new Promise((o) => {
              ((t.innerHTML = this.consentContent(e, n)),
                t
                  .querySelector('.cobrowse-allow')
                  .addEventListener('click', () => {
                    (o(!0), this.hideModal(t));
                  }),
                t
                  .querySelector('.cobrowse-deny')
                  .addEventListener('click', () => {
                    (o(!1), this.hideModal(t));
                  }),
