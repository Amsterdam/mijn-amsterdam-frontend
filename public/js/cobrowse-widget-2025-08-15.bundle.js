!(function (e, s) {
  ...
  (() => {
    ...
    var e = {
        d: (s, o) => {
          for (var t in o)
            e.o(o, t) &&
              !e.o(s, t) &&
              Object.defineProperty(s, t, { enumerable: !0, get: o[t] });
        },
    ...
    const o = JSON.parse(
      ...
      t = document.currentScript?.dataset?.licenseKey;
    let n = null;
    t &&
      (n = new (class {
        constructor(e, s = 'nl') {
        ...
        async loadCobrowseSDK() {
          ...
          try {
            ...
            return (
              ...
              new Promise((s, o) => {
                ((e.onload = () => s(window.CobrowseIO)),
                  (e.onerror = () =>
                    o(new Error('Failed to load Cobrowse SDK'))),
        ...
        displaySessionCodeModal(e, s = null) {
        ...
        sessionCodeContent(e, s, o, t = null) {
          const n = !0 === t ? 'blue-button' : 'secondary-button',
          ...
          return this.createModal(e, s, i);
        }
        showConsentDialog(e, s) {
          (this.hideModal(this.sessionCodeContainer),
            (this.sessionCodeContainer = null));
          const o = document.createElement('div');
          return (
            o.classList.add('cobrowse-wrapper'),
            new Promise((t) => {
              ((o.innerHTML = this.consentContent(e, s)),
                o
                  .querySelector('.cobrowse-allow')
                  .addEventListener('click', () => {
                    (t(!0), this.hideModal(o));
                  }),
                o
                  .querySelector('.cobrowse-deny')
                  .addEventListener('click', () => {
                    (t(!1), this.hideModal(o));
                  }),
