...
const IntermediateAPIHandler = require('./mocks/handlers/IntermediateAPIHandler.cjs');
const ProfileTypeHandler = require('./mocks/handlers/ProfileTypeHandler.cjs');

module.exports = {
  // Log level. Can be one of silly, debug, verbose, info, warn or error
  log: process.env.MOCKS_SERVER_LOG_LEVEL || 'info',
  config: {
