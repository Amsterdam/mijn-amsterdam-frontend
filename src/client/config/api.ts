...
export const ErrorNames: Record<string /* ApiStateKey */, string> = {
  ...
  WPI_AANVRAGEN: 'Uitkering en Stadspas -aanvragen + actuele updates',
  WPI_TOZO: 'Aanvraag Tozo',
  WPI_TONK: 'Aanvraag TONK',
  WPI_BBZ: 'Aanvraag Bbz',
  WPI_SPECIFICATIES: 'Uitkeringsspecificaties en jaaropgaven + actuele updates',
  WPI_STADSPAS: 'Informatie over uw stadspassen',
  ERFPACHT: 'Erfpacht',
  SUBSIDIE: 'Subsidies',
