...
export const FeatureToggle = {
  ...
  ehKetenmachtigingActive: false,
  eherkenningActive: true,
  erfpachtV2Active: false,
  erfpachtV2EndpointActive: false,
  ...
  zorgnedDocumentDecisionDateActive: false,
  zorgv2ThemapaginaActive: false,
};
