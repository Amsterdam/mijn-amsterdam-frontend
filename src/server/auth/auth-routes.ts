import { MIJN_AMSTERDAM_URL_PRODUCTION } from '../config/app.ts';
...
export const BFF_OIDC_BASE_URL = `${
  getFromEnv('BFF_OIDC_BASE_URL') ?? MIJN_AMSTERDAM_URL_PRODUCTION
}`;
...
export const authRoutes = {
  ...
  // Digid
  AUTH_CALLBACK_DIGID: AUTH_BASE_DIGID + AUTH_CALLBACK,
  ...
  // EHerkenning
  AUTH_CALLBACK_EHERKENNING: AUTH_BASE_EHERKENNING + AUTH_CALLBACK,
