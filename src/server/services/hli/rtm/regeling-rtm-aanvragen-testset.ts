  ...
  },
  {
    ...
    aanvragen: [
      aanvraag(RTM2, TOE, ['A6'], {
        ...
        procesAanvraag: {
          identificatie: 'xxx',
          datumStart: '2024-11-01',
          datumAfsluiten: '2024-11-30',
          omschrijving: 'Aanvraag RTM fase 2',
          acties: [],
        },
      }),
      aanvraag(RTM2, TOE, ['A6'], {
  ...
  },
  {
    ...
    aanvragen: [
      aanvraag(RTM2, TOE, ['A8'], {
        ...
        procesAanvraag: {
          identificatie: 'xxx',
          datumStart: '2024-12-01',
          datumAfsluiten: '2025-11-30',
          omschrijving: 'Aanvraag RTM fase 2',
          acties: [],
        },
      }),
