  ...
  [
    ...
    },
    {
      ...
      description: (regeling) => {
        ...
        return `
        <p>
         Voordat u de laptop of tablet krijgt, moet uw kind ${betrokkenKinderen} een workshop volgen. Hiervoor moet u eerst een afspraak maken. In de brief staat hoe u dat doet.
        </p>
      `;
      },
    },
