          ...
          steps: [
            {
              ...
              description:
                '<p> U krijgt geen gratis laptop of tablet voortgezet onderwijs voor uw kind Persoon B. </p> <p>In de brief vindt u meer informatie hierover en leest u hoe u bezwaar kunt maken.</p> <p> <a href="https://stadspas.amsterdam.nl/tegoed-en-meer/pc-tegoed" rel="external noopener noreferrer" title="Lees meer over PC Tegoed op Amsterdam.nl." > Lees meer over PC Tegoed op Amsterdam.nl </a> </p>',
              documents: [],
              id: 'status-step-0',
              isActive: true,
              isChecked: true,
