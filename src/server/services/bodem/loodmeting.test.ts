...
import document from '../../../mocks-server/fixtures/loodmeting-rapport.json' with { type: 'json' };
import metingen from '../../../mocks-server/fixtures/loodmetingen.json' with { type: 'json' };
