...
import testPersonenResponse from '../../../mocks-server/fixtures/brp/test-personen.json' with { type: 'json' };
import verblijfplaatsenResponse from '../../../mocks-server/fixtures/brp/verblijfplaatshistorie.json' with { type: 'json' };
