...
type A = VergunningFrontend;
type B = VergunningFrontend<GPP>;

type CheckIfExtends<T, U> = T extends U ? true : false;
type C = CheckIfExtends<B, A>;
...
export type VergunningFrontend<T extends DecosZaakBase = DecosZaakBase> = T & {
