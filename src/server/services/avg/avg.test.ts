...
import avgThemasResponse from '../../../mocks-server/fixtures/avg-themas.json' with { type: 'json' };
import apiResponse from '../../../mocks-server/fixtures/avg.json' with { type: 'json' };
