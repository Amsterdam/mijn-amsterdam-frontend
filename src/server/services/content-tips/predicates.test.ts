...
import WPI_AANVRAGEN from '../../../mocks-server/fixtures/wpi-aanvragen.json' with { type: 'json' };
import WPI_E from '../../../mocks-server/fixtures/wpi-e-aanvragen.json' with { type: 'json' };
