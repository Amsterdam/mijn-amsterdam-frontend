...
const siaResponse: /*SignalsSourceData*/ any = {
  _links: {
    self: {
      href: 'https://acc.api.meldingen.amsterdam.nl/signals/v1/private/signals/?contact_details=email&reporter_email=hela.hola%40amsterdam.nl',
    },
    next: {
      href: null,
    },
  ...
  results: [
    {
      _links: {
        self: {
          href: 'https://acc.api.meldingen.amsterdam.nl/signals/v1/private/signals/12419',
        },
      },
      ...
      category: {
        ...
        main_slug: 'overig',
        category_url:
          'https://acc.api.meldingen.amsterdam.nl/signals/v1/public/terms/categories/overig/sub_categories/overig',
        departments: 'ASC',
        created_by: null,
        text: null,
