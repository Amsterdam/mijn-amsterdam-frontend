...
import { IS_PRODUCTION, IS_TAP } from '../../../universal/config/env';
...
> = {
  afvalcontainers: {
    listUrl: IS_TAP
      ...
      : // To enable retrieving data from the mock server on a local environment.
        getFromEnv('BFF_AMSTERDAM_DATA_HUISHOUDELIJKAFVAL', true)!,
