...
import bezwarenDocumenten from '../../../mocks-server/fixtures/bezwaren-documents.json' with { type: 'json' };
import bezwarenStatus from '../../../mocks-server/fixtures/bezwaren-status.json' with { type: 'json' };
import bezwarenApiResponse from '../../../mocks-server/fixtures/bezwaren.json' with { type: 'json' };
