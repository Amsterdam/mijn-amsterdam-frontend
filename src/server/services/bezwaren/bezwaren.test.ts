...
import bezwarenDocumenten from '../../../../mocks/fixtures/bezwaren-documents.json' with { type: 'json' };
import bezwarenStatus from '../../../../mocks/fixtures/bezwaren-status.json' with { type: 'json' };
import bezwarenApiResponse from '../../../../mocks/fixtures/bezwaren.json' with { type: 'json' };
