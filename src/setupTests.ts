...
// Overwrite some BASE URLS, because some start with localhost:5000 for instance.
...
// Overwrite, to prevent logging a key through the test suite.
process.env.BFF_SERVER_CLIENT_CERT = 'FaKeKeYtT9jQBEGYCvS?H2rEh3hukwDz';
